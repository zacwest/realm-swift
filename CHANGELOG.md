...
* Sync progress notifiers would not trigger when the downloadable bytes size
  would equal 0. (since v10.0.0, [Core #4989](https://github.com/realm/realm-core/pull/4989))
...
### Internal
* Upgraded realm-core from v11.4.1 to v11.5.2
