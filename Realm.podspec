Pod::Spec.new do |s|
  ...
  # s.source_files = 'Realm/*.xcframework/**/**/*.a'
  ...
  #                               # 'USER_HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/Realm/include" "${PODS_ROOT}/Realm/include/Realm"',
                                # 'USER_HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/Realm/*.xcframework"/**'
                              }
  # s.preserve_paths          = %w(build.sh include)

  s.ios.deployment_target   = '11.0'
  # s.ios.vendored_library    = 'core/librealmcore-ios.a'
  # s.ios.vendored_libraries  = 'Realm/*.xcframework'
  ...
  s.source_files = 'Realm/Realm-Info.plist'
  # s.source_files = 'Realm/*.xcframework/**/*.hpp'
  s.vendored_frameworks = 'Realm/realm-core-dbg.xcframework'
  # s.source_files = 'Realm/*.xcframework/**/*.{hpp,a}'
  # s.public_header_files = 'Realm/*.xcframework/**/*.hpp'
